...
If the option to sign in is chosen: run **(1.2)**

If the option to create a new user is chosen: run **(1.3)**
...
If not all four digits have been selected: run **(1.2 a)**

If all four digits have been selected: run **(1.2 b)**
...
If the entered values match the user passcode from the database: run **(1.2 c)**
...
If the option to view accounts is chosen: **(1.2 d)**

If the option to create a new account is chosen: **(1.2 f)**

If the option to reset the user passcode is chosen: **(1.2 g)**
...
If the option to view one of the accounts was chosen: run **(1.2 e)**
...
If the button hasn’t been pressed: run **(1.4 b)**
    
<h5>1.4 b</h5>

If the difference between the first and second reading is less than -5: run **(1.4 c)**

If the difference between the first and second reading is greater than 5: run **(1.4 d)**
...
- If the currently selected menu option spans one line:
	...
	- Update the displayed lines to match the current menu data
	- Loop back to get a new rotary dial reading
- If the currently selected menu option spans two lines:
